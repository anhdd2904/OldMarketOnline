...
import com.due.oldmarket.dto.BillIdProductRequest;
...
public class BillController {
    ...
    public ResponseEntity<String> save(@RequestBody BillIdProductRequest billIdProductRequest,
        ...
        for (Long idProduct : billIdProductRequest.getIdProducts()) {
            Bill bill = new Bill();
            bill.setIdBill(billIdProductRequest.getIdBill());
            bill.setAmount(billIdProductRequest.getAmount());
            bill.setCreateDate(billIdProductRequest.getCreateDate());
            bill.setAddress(billIdProductRequest.getAddress());
            bill.setStatus(billIdProductRequest.getStatus());
            bill.setTotalPrice(billIdProductRequest.getTotalPrice());
    ...
    public ResponseEntity<List<BillReponse>> findBiIdUser(@PathVariable(value = "idUser") Long idUser,
        ...
        for (Bill bill : billList) {
            ...
            billReponse.setAddress(bill.getAddress());
