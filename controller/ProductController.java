...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> update(@PathVariable(value = "id") Long id,
        ...
        ProductDTO productDTO = productService.convertToProductDTO(productService.findById(id));
        ...
        for (MultipartFile file : files) {
            if (file.isEmpty()) {
                ...
                fileStorageService.deleteFileByIdProduct(id);
                for (MultipartFile file1 : files) {
                    fileStorageService.storeFileProduct(file1, id);
                }
            }
        }
        return new ResponseEntity<>(productDTO, HttpStatus.OK);
